...
_BALANCESMESSAGE_GET_ALL_BALANCES_PERFORMATIVE_PARAMSENTRY = _BALANCESMESSAGE_GET_ALL_BALANCES_PERFORMATIVE.nested_types_by_name['ParamsEntry']
...
_BALANCESMESSAGE_ERROR_PERFORMATIVE_ERRORDATAENTRY = _BALANCESMESSAGE_ERROR_PERFORMATIVE.nested_types_by_name['ErrorDataEntry']
_BALANCESMESSAGE_ERRORCODE_ERRORCODEENUM = _BALANCESMESSAGE_ERRORCODE.enum_types_by_name['ErrorCodeEnum']
BalancesMessage = _reflection.GeneratedProtocolMessageType('BalancesMessage', (_message.Message,), {
  ...
  'Get_All_Balances_Performative' : _reflection.GeneratedProtocolMessageType('Get_All_Balances_Performative', (_message.Message,), {
  ...
  'Get_Balance_Performative' : _reflection.GeneratedProtocolMessageType('Get_Balance_Performative', (_message.Message,), {
  ...
  'All_Balances_Performative' : _reflection.GeneratedProtocolMessageType('All_Balances_Performative', (_message.Message,), {
  ...
  'Balance_Performative' : _reflection.GeneratedProtocolMessageType('Balance_Performative', (_message.Message,), {
