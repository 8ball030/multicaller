...
_DEFAULTMESSAGE_ERROR_PERFORMATIVE_ERRORDATAENTRY = _DEFAULTMESSAGE_ERROR_PERFORMATIVE.nested_types_by_name['ErrorDataEntry']
...
DefaultMessage = _reflection.GeneratedProtocolMessageType('DefaultMessage', (_message.Message,), {
  ...
  'Bytes_Performative' : _reflection.GeneratedProtocolMessageType('Bytes_Performative', (_message.Message,), {
